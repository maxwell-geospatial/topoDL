...
images <- tibble(
  ...
  map(~do.call(c, .x))
out <- magick::image_aprint(out)
image_write(out, "E:/example_results2.png")ppend(c(
...
#Function to add rows and columns to data to generate image chips of fixed size
